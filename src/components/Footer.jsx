  ...
  <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <h1 className='text-2xl text-teal-600'><span className='logo_font'>GO</span>TRAVEL</h1>
      ...
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
        <div>
          <p class="font-medium text-gray-900">USEFULL LINKS</p>
          ...
          <ul class="mt-6 space-y-4 text-sm">
            ...
            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Destination </a>
            </li>
            ...
            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> package </a>
            </li>

            <li>
              <a href="#" class="text-gray-700 transition hover:opacity-75"> Guides </a>
            </li>
          </ul>
        </div>
